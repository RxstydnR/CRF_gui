...
def crf(original_image, annotated_image, 
       gt_prob, n_inference, gau_sxy, gau_compat, bil_sxy, bil_srgb, bil_compat, use_2d=True):
    ...
    if use_2d :
        ...
        U = unary_from_labels(labels, n_labels, gt_prob=gt_prob, zero_unsure=False) # U -> (n_label, flatten shape)
        ...
        d.addPairwiseGaussian(sxy=(gau_sxy,gau_sxy), compat=gau_compat, kernel=dcrf.DIAG_KERNEL,
                          normalization=dcrf.NORMALIZE_SYMMETRIC)

        # Appearance kernel
        # This adds the color-dependent term, i.e. features are (x,y,r,g,b).
        d.addPairwiseBilateral(sxy=(bil_sxy, bil_sxy), srgb=(bil_srgb, bil_srgb, bil_srgb), 
